    ...
    <div className="py-8">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div>
              <div className="mb-4">
                ...
                <p className="text-4xl xl:text-5xl font-semibold opacity-20 mb-2">
                  Earphone
                </p>
          ...
          {/* third cat */}
          <div
            className="col-span-2 py-10 pl-10 bg-gradient-to-br from-primary to-primary rounded-3xl
          text-white relative h-[320px]  flex items-end"
          >
            <div className="">
